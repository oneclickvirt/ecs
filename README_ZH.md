...
- 网速测试：基于公开的 [speedtest.net](https://github.com/spiritLHLS/speedtest.net-CN-ID) 和 [speedtest.cn](https://github.com/spiritLHLS/speedtest.cn-CN-ID) 数据，开发 [oneclickvirt/speedtest](https://github.com/oneclickvirt/speedtest)；上游 v1.8.3 为 speedtest.net 用户配置请求加入缓存旁路，并在上传前跟随临时重定向
