...
func defaultMainItems() []mainMenuItem {
	return []mainMenuItem{
		...
		{id: "6", zh: "精简解锁版", en: "Unlock Suite", descZh: "系统信息+CPU+内存+磁盘IO+跨国平台解锁+测速节点×4。", descEn: "System info + CPU + memory + disk IO + streaming unlock + 5 speed nodes.", needNet: false},
		{id: "7", zh: "网络单项", en: "Network Only", descZh: "仅网络维度：IP质量、回程、NT3、延迟、TCP握手、TGDC、网站和4个测速节点。", descEn: "Network-only profile: IP quality, route, latency, TCP handshake, TGDC, websites and speed.", needNet: true},
